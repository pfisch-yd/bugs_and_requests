...
df_play = spark.sql(f"""
with old_table as (
    select * from ydx_internal_analysts_gold.{demo_name}{table_suffix}
    where month not in ("2025-10-01")
)
...
# 2025-10-24 18:03:26,962] INFO [fp_api_client.get_or_create_query_template:1390] Found matching template: 3222
...
# Create deliverable : FPModel 17897 : 2min
# FPModel 17896
# FPModel 17896
# FPModelVersion (698499)
...
# issue,
# the thing was already release. What do I do now?
# FPMaterialization 589560
# FPMaterialization 589778
# FPMaterialization 589788
