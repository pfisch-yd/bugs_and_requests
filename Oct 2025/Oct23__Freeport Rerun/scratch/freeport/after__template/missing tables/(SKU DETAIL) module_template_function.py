...
# MAGIC %md
# MAGIC ** module_template_function **
...
# MAGIC %sql
# MAGIC --- f"{ss_catalog}.{schema}.{demo_name}{table_suffix}"
# MAGIC select * from yd_sensitive_corporate.ydx_internal_analysts_gold.testesteelauder_v38_sku_detail
