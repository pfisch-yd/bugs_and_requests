...
column = "null"
table_suffix = '_market_share_for_column_'+column+'_nrf_calendar'
table_nickname = "msnrf"+column

# COMMAND ----------

def freeport_market_share_nrf_calendar(sandbox_schema, prod_schema, demo_name, column):
    table_suffix = '_market_share_for_column_'+column+'_nrf_calendar'
    table_nickname = "msnrf"+column
...
try:
    ...
    freeport_market_share_nrf_calendar(sandbox_schema, prod_schema, demo_name, column)
except:
