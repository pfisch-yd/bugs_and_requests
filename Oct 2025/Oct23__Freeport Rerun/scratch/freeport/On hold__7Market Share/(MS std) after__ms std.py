...
column = "null"
table_suffix = '_market_share_for_column_'+column+'_standard_calendar'
table_nickname = "msstd"+column

# COMMAND ----------

def freeport_market_share_standard_calendar(sandbox_schema, prod_schema, demo_name, column):
    table_suffix = '_market_share_for_column_'+column+'_standard_calendar'
    table_nickname = "msstd"+column
    ...
    deliverable = get_or_create_deliverable(
        ...
        output_table=fp_catalog+"."+prod_schema + "."+demo_name+table_suffix+'1',
...
try:
    ...
    freeport_market_share_standard_calendar(sandbox_schema, prod_schema, demo_name, column)
except:
