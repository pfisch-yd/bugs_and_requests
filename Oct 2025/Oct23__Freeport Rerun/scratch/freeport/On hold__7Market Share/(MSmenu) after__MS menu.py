...
table_suffix = "_display_interval_monthly"
table_nickname = "msmenu"

# COMMAND ----------

def freeport_display_interval_monthly(sandbox_schema, prod_schema, demo_name):
    table_suffix = "_display_interval_monthly"
    table_nickname = "msmenu"
...
try:
    ...
    freeport_display_interval_monthly(sandbox_schema, prod_schema, demo_name)
except:
