...
column = "null"
table_suffix = '_market_share_for_column_'+column
table_nickname = "mscol"+column

# COMMAND ----------

def freeport_market_share_for_column(sandbox_schema, prod_schema, demo_name, column):
    table_suffix = '_market_share_for_column_'+column
    table_nickname = "mscol"+column
...
try:
    ...
    freeport_market_share_for_column(sandbox_schema, prod_schema, demo_name, column)
except:
