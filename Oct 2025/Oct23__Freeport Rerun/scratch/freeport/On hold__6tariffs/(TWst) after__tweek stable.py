...
def freeport_tariffs_week_stable_products_list(sandbox_schema, prod_schema, demo_name):
    table_suffix = "_tariffs_week_stable_products_list"
    table_nickname = "twst"
...
try:
    ...
    freeport_tariffs_week_stable_products_list(sandbox_schema, prod_schema, demo_name)
except:
