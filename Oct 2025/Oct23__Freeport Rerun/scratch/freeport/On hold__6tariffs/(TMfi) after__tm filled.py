...
def freeport_tariffs_month_product_filled_prices(sandbox_schema, prod_schema, demo_name):
    table_suffix = "_tariffs_month_product_filled_prices"
    table_nickname = "tmfi"
...
try:
    ...
    freeport_tariffs_month_product_filled_prices(sandbox_schema, prod_schema, demo_name)
except:
