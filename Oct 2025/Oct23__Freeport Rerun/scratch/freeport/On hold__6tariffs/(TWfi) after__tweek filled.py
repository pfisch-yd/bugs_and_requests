...
def freeport_tariffs_week_product_filled_prices(sandbox_schema, prod_schema, demo_name):
    table_suffix = "_tariffs_week_product_filled_prices"
    table_nickname = "twfi"
...
try:
    ...
    freeport_tariffs_week_product_filled_prices(sandbox_schema, prod_schema, demo_name)
except:
