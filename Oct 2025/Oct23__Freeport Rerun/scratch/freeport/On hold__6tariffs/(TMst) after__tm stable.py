...
def freeport_tariffs_month_stable_products_list(sandbox_schema, prod_schema, demo_name):
    table_suffix = "_tariffs_month_stable_products_list"
    table_nickname = "tmst"
...
try:
    ...
    freeport_tariffs_month_stable_products_list(sandbox_schema, prod_schema, demo_name)
except:
