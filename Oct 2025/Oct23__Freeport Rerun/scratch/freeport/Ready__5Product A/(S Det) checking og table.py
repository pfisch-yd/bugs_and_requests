...
for i in range(0, len(all_columns)):
    ...
    if df.collect()[0][0] > 0:
        ...
        lowercase_accepted_columns.append(all_columns[i].lower())
    else:
        print("unnaccepted")
...
module_name = "pfisch__"+table_nickname+"_20250923d"
...
deliverable = get_or_create_deliverable(
    ...
    query_parameters={"columns": accepted_columns, "lower_case_columns": accepted_columns},
