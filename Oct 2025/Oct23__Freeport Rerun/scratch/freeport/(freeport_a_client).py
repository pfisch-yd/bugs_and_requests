...
# corporate_transformation_blueprints/retail_analytics_platform/freeport/freeport_all_tables
# corporate_transformation_blueprints/(freeport_a_client)

%run "../retail_analytics_platform/freeport/freeport_all_tables"

# COMMAND ----------

# MAGIC %run "./retail_analytics_platform/freeport/freeport_all_tables"
