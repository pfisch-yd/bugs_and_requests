...
# MAGIC
# MAGIC ### Answer:
# MAGIC Well, at least, it seems like they were both created by the same commit

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC describe history yd_sensitive_corporate.ydx_lowes_analysts_gold.lowes_v38_market_share_for_column_null_nrf_calendar
...
"a323049f79c43ff57bba88f8a24cf20261e38b97" == "a323049f79c43ff57bba88f8a24cf20261e38b97"
...
# MAGIC
# MAGIC they were both updated after the 15th,
...
# MAGIC   notebook_path,
# MAGIC   error,
# MAGIC   CASE WHEN error IS NULL THEN 'SUCCESS' ELSE 'FAILED' E ND as status
...
# MAGIC SELECT
# MAGIC     *
# MAGIC from yd_production.ydx_retail_us_static.454cal
# MAGIC WHERE cal_day = '2025-01-15'
...
# MAGIC     *
# MAGIC from yd_production.ydx_retail_us_static.454cal
# MAGIC WHERE cal_day in ('2025-01-15','2025-08-31')

# COMMAND ----------

# MAGIC %md
# MAGIC [creating 454](https://yipitdata-corporate.cloud.databricks.com/editor/notebooks/3152554959606621?o=3092962415911490#command/8332175227277709)
